                                ...
                                <div className="row">
                                    <div className="col-md-4" style={{backgroundSize: "cover"}}>
                                        <div style={{padding: "40px"}}>
                                            <h2 style={{marginBottom: "20px" , color: "#e56100" , fontSize: "40px"}}><span className="uptitle">  </span> Our Serices</h2>
                                    ...
                                    <div className="col-md-8">
                                        <div style={{padding: "40px"}}>
                                            <h2 style={{marginBottom: "20px" , color: "#e56100" , fontSize: "40px"}}> Logo Design</h2>
                                            <img src={Logodesign} className="img-fluid" alt="" />
