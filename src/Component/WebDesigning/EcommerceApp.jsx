...
import ecommereapp from "../images/ecommere-app.jpg";
import "../css/bg.css";
                            ...
                            <div className="container" style={{backgroundSize: "cover"}}>
                                <div className="row">
                                    ...
                                    <div className="col-md-8">
                                        <div style={{padding: "40px"}}>
                                            <h2 style={{marginBottom: "20px" , color: "#e56100" , fontSize: "40px"}}> eCommerce Website Design</h2>
                                            <img src={ecommereapp} className="img-fluid" alt="" />
