                            ...
                            <div className="container" style={{backgroundSize: "cover"}}>
                                <div className="row">
                                    ...
                                    <div className="col-md-8">
                                        <div style={{padding: "40px"}}>
                                            <h2 style={{marginBottom: "20px" , color: "#e56100" , fontSize: "40px"}}>Reach Native App Development</h2>
