import Brochuredesign from "../images/brochure-design.jpg";
                            ...
                            <div className="container" style={{backgroundSize: "cover"}}>
                                <div className="row">
                                    ...
                                    <div className="col-md-8">
                                        <div style={{padding: "40px"}}>
                                            <h2 style={{marginBottom: "20px" , color: "#e56100" , fontSize: "40px"}}>Brochure Design</h2>
                                            <img src={Brochuredesign} className="img-fluid" alt="" />
