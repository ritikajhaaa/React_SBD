...
import ecommerce from "../images/ecommerce-1.jpg"
import "../css/bg.css";
import "../WebDesigning/WebDesign.css";
export default function EcommericeWeb(){
    return(
        <div>
             <section
                id="subheader"
                            ...
                            <div className="container" style={{backgroundSize: "cover"}}>
                                <div className="row">
                                    ...
                                    <div className="col-md-8">
                                        <div style={{padding: "40px"}}>
                                            <h2 style={{marginBottom: "20px" , color: "#e56100" , fontSize: "40px"}}> eCommere App</h2>
